...
const SixthSection = () => {
    ...
    return (
        <>
            <Box id="super-merchants" component="section" sx={{ backgroundImage: "url('/sec6-img1.svg')", backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }} display="flex" flexDirection="column" justifyContent="center" alignItems="center" p={16} height="100vh" color="#FFFFFF" bgcolor="#4B42AD" textAlign="center">
